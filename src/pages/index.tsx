      ...
      >
        ...
        >
          <div style={{ flex: "1", minWidth: "340px" }}>
            ...
            >
              Explore guides, SDKs, and walkthroughs to help you build, test,
              and deploy AI agents efficiently using the SVAHNAR Platform.
            </p>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <span style={{ color: "#CF222E" }}>from</span> svahnar{" "}
                    <span style={{ color: "#CF222E" }}>import</span> Svahnar
                    <br />
                    <br />
                    client = Svahnar()
                    <br />
                    ...
                    <br />
                    &nbsp;&nbsp;name=
                    <span style={{ color: "#0A3069" }}>"Web Search Agent"</span>
                    ,<br />
                    &nbsp;&nbsp;description=
                    ...
                    ,<br />
                    &nbsp;&nbsp;deploy_to=
                    <span style={{ color: "#0A3069" }}>"Organization"</span>,
                    <br />
                    &nbsp;&nbsp;yaml_content=Path(
                    <span style={{ color: "#0A3069" }}>"agent.yaml"</span>)
                    <br />
                    )<br />
        ...
        <section>
          <div className="console-banner">
            <div style={{ flex: "1 1 300px", padding: "3rem" }}>
              ...
              >
                Create your first AI Agent in seconds using the SVAHNAR Agent
                Console. Manage, monitor, and deploy with zero code.
              </p>
              <a
                href="https://platform.svahnar.com"
                target="_blank"
        ...
        <section>
          <div style={{ marginBottom: "2.5rem" }}>
            ...
            >
              Pick the developer surface that matches your approach, and the
              infrastructure that fits your stack.
            </p>
          </div>

          <div className="feature-grid">
            <VersionedLink
              to="/docs/AgenticNetwork/introduction"
            ...
            >
              ...
              <p>
                Build and orchestrate single agents or agentic networks using
                the Python SDK.
              </p>
            ...
            >
              ...
              <p>
                Programmatically validate, test, run, and manage your AI agent
                instances.
              </p>
              <div className="feature-card-link">
            ...
            <VersionedLink to="/docs/Keyvault" className="feature-card">
              ...
              <p>
                Securely store, retrieve, and revoke credentials and API keys
                used by your agents.
              </p>
              <div className="feature-card-link">
            ...
            <VersionedLink to="/docs/MCP/usage" className="feature-card">
              ...
              <p>
                Use Model Context Protocol to seamlessly connect agents to
            ...
            <VersionedLink
              to="/docs/Tools/Understanding_Tools"
              className="feature-card"
            >
              <div className="feature-card-header">
                <div className="feature-card-icon">
              ...
              <p>
                Equip your agents with Google Search, Finance APIs, and
            ...
            <VersionedLink
              to="/docs/KnowledgeRepository/Overview"
              className="feature-card"
            >
              <div className="feature-card-header">
                <div className="feature-card-icon">
              ...
              <p>
                Connect documents, file databases, and vector storage to agent
                memory.
              </p>
              <div className="feature-card-link">
            ...
            >
              ...
              <p>
                Set up Slack, Google, GitHub, Outlook, and other OAuth
            ...
            <VersionedLink
              to="/docs/additional/YAML_Conversion_Guide"
              className="feature-card"
            >
              <div className="feature-card-header">
                <div className="feature-card-icon">
              ...
              <p>
                Access conversion guides, configuration schemas, and other
                resources.
              </p>
              <div className="feature-card-link">
