...
## Usage
- Just provide the URL in form `https://yoururl.com`. It will extract the page content if images are there then that will also be extracted.
- For images it will use OCR to extract data
