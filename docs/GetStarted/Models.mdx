---
title: "Models | SVAHNAR AI Developer Docs"
description: "Explore the large language models (LLMs) supported by SVAHNAR, including GPT-4o, GPT-5, Llama, and Deepseek."
keywords: ['ai models', 'llm', 'gpt-4o', 'gpt-5', 'llama', 'deepseek', 'qwen', 'svahnar models', 'svahnar', 'ai agent', 'developer documentation', 'models']
