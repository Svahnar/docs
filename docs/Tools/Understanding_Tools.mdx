---
title: "Understanding Tools | SVAHNAR AI Developer Docs"
description: "Learn how tools work in SVAHNAR AI agents, including how LLMs call tools to take real-world actions."
keywords: ['ai tools', 'agent tools', 'svahnar', 'tool calling', 'llm tools', 'ai agent', 'developer documentation', 'understanding tools', 'tool integration', 'api integration']
sidebar_label: "Understanding Tools"
---
...
For enhanced control over tool behavior, SVAHNAR supports:

- **Human-in-the-Loop (HITL)**: Require human approval for sensitive operations
- **Custom Instructions**: Add tool-specific guidance for the AI agent

See the [Tools Configuration](/docs/AgenticNetwork/Configuration/Tools) guide to learn more.