---
title: "Custom Instruction | SVAHNAR AI Developer Docs"
description: "Learn how to use Custom Instruction in SVAHNAR. Add tool-specific instructions to guide AI agent behavior for individual tool calls."
keywords: ['custom instruction', 'tool instruction', 'agent configuration', 'svahnar', 'ai tool guidance', 'ai agent', 'developer documentation', 'agent tools', 'tool integration', 'api integration']
sidebar_label: "Custom Instruction"
---
# Custom Instruction
