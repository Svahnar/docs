...
:::tip
If you already use the [Google Jobs](./Google%20Jobs.mdx) tool, your **SerpApi key is the same** — one key works across all SerpApi-powered tools in SVAHNAR. No separate account needed.
:::
