---
title: "Gmail Tool Integration Guide | SVAHNAR Docs"
description: "Read, send, and manage Gmail emails directly from your SVAHNAR AI agents with full OAuth integration."
keywords: ['gmail tool', 'google mail', 'email automation', 'svahnar', 'google workspace', 'ai agent', 'developer documentation', 'gmail', 'agent tools', 'tool integration', 'api integration']
unlisted: true
sidebar_label: "Gmail"
---
