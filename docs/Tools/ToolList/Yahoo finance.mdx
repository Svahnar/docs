...
:::note
This tool returns **news articles** — headlines, summaries, and links to coverage. It does not return live stock prices, financial statements, or historical price data. For real-time prices, use the [Google Finance](./Google%20finance.mdx) tool. For financial computations, use the [WolframAlpha](./Wolframalpha.mdx) tool.
:::
