---
title: "Weather Tool Integration Guide | SVAHNAR Docs"
description: "Fetch real-time weather conditions and forecasts for any city using OpenWeatherMap in SVAHNAR agents."
keywords: ['weather tool', 'openweathermap', 'weather api', 'svahnar', 'real-time weather', 'ai agent', 'developer documentation', 'weather', 'agent tools', 'tool integration', 'api integration']
