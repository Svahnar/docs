---
title: "Wikidata Tool Integration Guide | SVAHNAR Docs"
description: "Query structured factual data about people, places, and events from Wikidata in your SVAHNAR agents."
keywords: ['wikidata', 'structured knowledge', 'knowledge graph', 'svahnar', 'facts', 'ai agent', 'developer documentation', 'agent tools', 'tool integration', 'api integration']
