---
title: "GitLab Tool Integration Guide | SVAHNAR Docs"
description: "Connect your SVAHNAR AI agents to GitLab to manage repositories, pipelines, and issues programmatically."
keywords: ['gitlab tool', 'devops', 'ci cd', 'svahnar', 'git integration', 'ai agent', 'developer documentation', 'gitlab', 'agent tools', 'tool integration', 'api integration']
...
![Select Scopes](../../assets/gitlab_scopes.png)
