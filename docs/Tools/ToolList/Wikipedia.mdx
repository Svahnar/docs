---
title: "Wikipedia Tool Integration Guide | SVAHNAR Docs"
description: "Enable SVAHNAR AI agents to search Wikipedia for article summaries and encyclopedic knowledge."
keywords: ['wikipedia tool', 'encyclopedia', 'knowledge search', 'svahnar', 'agent tool', 'ai agent', 'developer documentation', 'wikipedia', 'agent tools', 'tool integration', 'api integration']
