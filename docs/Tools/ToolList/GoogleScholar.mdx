---
title: "Google Scholar Tool Integration Guide | SVAHNAR Docs"
description: "Enable SVAHNAR AI agents to search academic research and citations via Google Scholar."
keywords: ['google scholar', 'academic research', 'citations', 'svahnar', 'research tool', 'ai agent', 'developer documentation', 'agent tools', 'tool integration', 'api integration']
...
:::tip
If you already use [Google Jobs](./GoogleJobs.mdx), [Google Finance](./GoogleFinance.mdx), [Google Flights](./GoogleFlight.mdx), or [Google Hotels](./GoogleHotel.mdx) tools, your **SerpApi key is the same** — one key works across all SerpApi-powered tools in SVAHNAR.
:::
