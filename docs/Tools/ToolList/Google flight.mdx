...
:::tip
If you already use the [Google Jobs](./Google%20Jobs.mdx) or [Google Finance](./Google%20finance.mdx) tools, your **SerpApi key is the same** — one key works across all SerpApi-powered tools in SVAHNAR.
:::
