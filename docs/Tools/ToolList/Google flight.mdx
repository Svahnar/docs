...
:::tip
If you already use the [Google Jobs](/docs/google-jobs) or [Google Finance](/docs/google-finance) tools, your **SerpApi key is the same** — one key works across all SerpApi-powered tools in SVAHNAR.
:::
