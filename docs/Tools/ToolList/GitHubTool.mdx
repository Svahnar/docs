---
title: "GitHub Tool Integration Guide | SVAHNAR Docs"
description: "Manage GitHub repositories, issues, and pull requests directly from your SVAHNAR AI agents."
keywords: ['github tool', 'repository', 'code management', 'svahnar', 'git integration', 'ai agent', 'developer documentation', 'github', 'agent tools', 'tool integration', 'api integration']
