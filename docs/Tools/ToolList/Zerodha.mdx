---
title: "Zerodha Kite Tool Integration Guide | SVAHNAR Docs"
description: "Fetch market data, place trades, and manage portfolios via Zerodha Kite Connect in your SVAHNAR AI agents."
keywords: ['zerodha', 'kite connect', 'trading', 'stock market', 'svahnar', 'ai agent', 'developer documentation', 'zerodha kite', 'agent tools', 'tool integration', 'api integration']
unlisted: true
sidebar_label: "Zerodha Kite"
---
