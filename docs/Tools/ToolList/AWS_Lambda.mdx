...
<p>**Note**:- With it you can also extend functionality by integrating your own custom functions. These functions can act as standalone tools, deployed via AWS Lambda, and can be invoked by passing the required parameters. </p>
