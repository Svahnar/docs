---
title: "Jira Tool Integration Guide | SVAHNAR Docs"
description: "Create, update, and manage Jira issues and projects directly from your SVAHNAR AI agents."
keywords: ['jira tool', 'project management', 'atlassian', 'svahnar', 'issue tracking', 'ai agent', 'developer documentation', 'jira', 'agent tools', 'tool integration', 'api integration']
sidebar_label: "Jira"
---
