---
title: "Google Jobs Tool Integration Guide | SVAHNAR Docs"
description: "Search and retrieve job listings from Google Jobs within your SVAHNAR AI agent workflows."
keywords: ['google jobs', 'job search', 'recruitment', 'svahnar', 'agent tool', 'ai agent', 'developer documentation', 'agent tools', 'tool integration', 'api integration']
sidebar_label: "Google Jobs"
---
