---
title: "Database Tool Tool Integration Guide | SVAHNAR Docs"
description: "Enable SVAHNAR AI agents to read and write to databases using the Database Tool with full SQL support."
keywords: ['database tool', 'sql', 'query database', 'svahnar', 'agent database', 'ai agent', 'developer documentation', 'agent tools', 'tool integration', 'api integration']
sidebar_label: "Database Tool"
---
