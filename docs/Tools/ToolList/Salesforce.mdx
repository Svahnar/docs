---
title: "Salesforce Tool Integration Guide | SVAHNAR Docs"
description: "Query and manage Salesforce CRM data, accounts, and opportunities directly from your SVAHNAR AI agents."
keywords: ['salesforce tool', 'crm', 'salesforce api', 'svahnar', 'sales automation', 'ai agent', 'developer documentation', 'salesforce', 'agent tools', 'tool integration', 'api integration']
...
![Reset Security Token](../../assets/saleforce-reset-token.png)
