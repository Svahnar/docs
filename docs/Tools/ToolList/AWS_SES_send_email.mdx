---
title: "AWS SES Tool Integration Guide | SVAHNAR Docs"
description: "Send transactional emails from your SVAHNAR AI agents using Amazon Simple Email Service (SES)."
keywords: ['aws ses', 'send email', 'amazon ses', 'svahnar', 'email automation', 'ai agent', 'developer documentation', 'agent tools', 'tool integration', 'api integration']
