...
You can register **any OAuth 2.0 service** — an internal API, a private SaaS tool, or an MCP server your team controls — as a custom OAuth connection. You supply your own Client ID, Client Secret, and OAuth endpoints; SVAHNAR handles token storage, automatic refresh, and injection into agent requests.
