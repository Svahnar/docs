---
title: "Connect SVAHNAR to Box | OAuth Setup"
...
keywords: ['box', 'oauth', 'svahnar', 'connect', 'knowledge repository', 'file storage', 'ai agent', 'developer documentation', 'oauth connection', 'integration credentials', 'oauth 2.0']
sidebar_label: "Box"
unlisted: true
---
