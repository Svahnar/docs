---
title: "Confluence | SVAHNAR AI Developer Docs"
description: "Integrate Atlassian Confluence as a knowledge source for SVAHNAR's AI agents via the KnowledgeRepository."
keywords: ['confluence connector', 'atlassian', 'knowledge repository', 'svahnar', 'rag', 'ai agent', 'developer documentation', 'confluence']
...
Seamlessly import pages, hierarchies, and attachments from your Confluence workspace into the SVAHNAR KnowledgeRepository.
...
The connector acts as a read-only ingestion tool. It connects to your Confluence instance using an API token, crawls the specified `space_key`, and normalizes the content (text, tables, and attachments) for the KnowledgeRepository.
...
### Execute Import
  ...
  1. Pass your configuration payload to the KnowledgeRepository connector tool.
