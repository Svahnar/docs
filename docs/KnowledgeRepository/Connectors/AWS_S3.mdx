---
title: "AWS S3 | SVAHNAR AI Developer Docs"
description: "Connect your AWS S3 buckets as a knowledge source for SVAHNAR's KnowledgeRepository and RAG pipelines."
keywords: ['aws s3', 's3 connector', 'knowledge repository', 'svahnar', 'rag', 'ai agent', 'developer documentation']
...
Connect your KnowledgeRepository directly to **Amazon S3** to ingest documents automatically.
...
Documents imported via this connector become part of your KnowledgeRepository.

* **KnowledgeRepository Access:** Agents with access to this Knowledge Base can read these files.
