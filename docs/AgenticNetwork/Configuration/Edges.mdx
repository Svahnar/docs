---
title: "Edges Reference Guide | SVAHNAR Docs"
description: "Configure edges in SVAHNAR agentic networks to define routing logic and agent-to-agent communication."
keywords: ['edges', 'agent routing', 'agentic network', 'svahnar', 'workflow routing', 'ai agent', 'developer documentation', 'multi-agent orchestration', 'yaml config', 'agentic workflows']
sidebar_label: "Edges"
---
