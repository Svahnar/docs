---
title: "Agent Function Reference Guide | SVAHNAR Docs"
description: "Configure agent functions in SVAHNAR to control agent behavior, prompts, and decision logic."
keywords: ['agent function', 'configuration', 'svahnar', 'prompt', 'agent behavior', 'ai agent', 'developer documentation', 'multi-agent orchestration', 'yaml config', 'agentic workflows']
sidebar_label: "Agent Function"
---
