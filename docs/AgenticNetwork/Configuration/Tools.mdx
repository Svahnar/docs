...
- **config**: Contains tool-specific parameters.
  - **`HITL`** (optional): Set to `true` to require human approval before tool execution. See [Human-in-the-Loop](/docs/AgenticNetwork/Configuration/HITL) for details.
  - **`instruction`** (optional): Custom instructions to guide how the agent uses this tool. See [Custom Instruction](/docs/AgenticNetwork/Configuration/Custom_Instruction) for details.
...
- [Human-in-the-Loop (HITL)](/docs/AgenticNetwork/Configuration/HITL) - Require human approval for tool execution
- [Custom Instruction](/docs/AgenticNetwork/Configuration/Custom_Instruction) - Add tool-specific guidance
