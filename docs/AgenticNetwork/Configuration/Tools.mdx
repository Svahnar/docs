---
title: "Tools Reference Guide | SVAHNAR Docs"
description: "Learn how to configure and assign tools to your SVAHNAR agents for enhanced capabilities."
keywords: ['tools configuration', 'agent tools', 'svahnar', 'tool setup', 'ai tools', 'ai agent', 'developer documentation', 'tools', 'tool integration', 'api integration']
sidebar_label: "Tools"
---
# Tools Configuration
