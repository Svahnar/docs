...
| agent_function   | string  | List of functions the agent performs                                          | Yes      | "Your goal is to send a request to the API endpoint with the given parameters. Make sure you check the parameters before sending the request. Parameters are: "param1": "value1", "param2": "value2"          |
...
| tools            | object  | Tools assigned to the agent                                                   | No       | [See Tool Configuration](/docs/AgenticNetwork/Configuration/Tools)    |
