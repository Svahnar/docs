---
title: "Create Simple Agent Configuration Guide | SVAHNAR Docs"
description: "Step-by-step guide to creating a simple AI agent on SVAHNAR using YAML configuration."
keywords: ['create agent', 'simple agent', 'yaml config', 'svahnar', 'ai agent tutorial', 'ai agent', 'developer documentation', 'create simple agent', 'multi-agent orchestration', 'agentic workflows']
